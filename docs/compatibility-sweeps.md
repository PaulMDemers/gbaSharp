...
- `artifacts/compat-curated-1-20-after-tactics-biosword0-20260625.csv` and `artifacts/compat-curated-21-40-after-tactics-biosword0-20260625.csv` refresh the curated front action/fighting block: indexes 1-40 produce 160/160 Release gameplay boot rows, 0 static, 0 crashes, and 0 timeouts. This keeps the external-BIOS byte guard coverage for Legends of Wrestling II (`A2LE`, index 31) clean alongside the Doom, Duke Nukem, Dragon Ball, fighting, and Boktai entries.
- `artifacts/compat-curated-41-60-after-tactics-biosword0-20260625.csv`, `artifacts/compat-curated-61-80-after-tactics-biosword0-20260625.csv`, and `artifacts/compat-curated-81-100-after-tactics-biosword0-20260625.csv` refresh the older licensed/action/noise band after the Tactics Ogre BIOS-word guard: indexes 41-100 produce 240/240 Release gameplay boot rows, 0 static, 0 crashes, and 0 timeouts. This supersedes the historical sweep-budget noise around WarioWare Twisted (`RZWE`), Powerpuff Girls (`APTE`), Scooby-Doo Unmasked (`B25E`), Lizzie McGuire 2 (`BL4E`), Mega Man Battle Network 3 White (`A6BE`), Castlevania Circle of the Moon (`AAMJ`), and Activision Anthology (`BAVE`).
- `artifacts/compat-curated-101-120-after-tactics-biosword0-20260625.csv`, `artifacts/compat-curated-121-140-after-tactics-biosword0-20260625.csv`, `artifacts/compat-curated-141-160-after-tactics-biosword0-20260625.csv`, `artifacts/compat-curated-161-180-after-tactics-biosword0-20260625.csv`, and `artifacts/compat-curated-181-200-after-tactics-biosword0-20260625.csv` refresh the curated middle action/collection/racing block after the Tactics Ogre BIOS-word guard: indexes 101-200 produce 400/400 Release gameplay boot rows, 0 static, 0 crashes, and 0 timeouts under the 180-second focused cap. Expected low-change generic probes remain in some Classic NES/Famicom Mini and title-screen rows, but every phase reaches the boot classifier.
...
- `artifacts/compat-curated-221-240-after-tactics-biosword0-20260625.csv`, `artifacts/compat-curated-241-260-after-tactics-biosword0-20260625.csv`, `artifacts/compat-curated-261-280-after-tactics-biosword0-20260625.csv`, and `artifacts/compat-curated-281-300-after-tactics-biosword0-20260625.csv` refresh the curated tail after the Tactics Ogre BIOS-word guard: indexes 221-300 produce 320/320 Release gameplay boot rows, 0 static, 0 crashes, and 0 timeouts. Combined with the refreshed 1-220 sweeps, the current post-fix 1-300 block is 1,200/1,200 gameplay boot rows under the no-BIOS path.
