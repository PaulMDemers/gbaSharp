...
- Expand `docs/gba-deep-gameplay-routes.csv` from generic route smokes into game-specific scripts that reach deterministic playable scenes, then promote stable final frames into visual baselines.
