...
- Continue expanding `docs/gba-deep-gameplay-routes.csv` toward 30 representative gameplay scenes across additional RPG, racing, sports, and technical-stress titles. Good next candidates are Mario & Luigi, Crash/Spyro superpacks, Mega Man Battle Network sequels, racing/sports entries, and deeper Scooby/Muppets routes.
