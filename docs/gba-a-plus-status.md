...
- Run the full 12-route strict deep gameplay suite after the latest route upgrades, then expand `docs/gba-deep-gameplay-routes.csv` to 20-30 representative gameplay scenes across additional RPG, platformer, racing, sports, and technical-stress titles.
