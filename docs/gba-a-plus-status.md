...
- Continue expanding `docs/gba-deep-gameplay-routes.csv` toward 30 representative gameplay scenes across additional RPG, platformer, racing, sports, and technical-stress titles. Good next candidates are Scooby-Doo Unmasked, Spy Muppets, Mario & Luigi, Castlevania Circle/Harmony, Crash/Spyro superpacks, and Mega Man Battle Network sequels.
