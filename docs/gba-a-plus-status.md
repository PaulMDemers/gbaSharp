...
- Continue expanding `docs/gba-deep-gameplay-routes.csv` toward 30 representative gameplay scenes across additional RPG, platformer, racing, sports, and technical-stress titles. Good next candidates are Mario & Luigi, Castlevania Circle/Harmony, Crash/Spyro superpacks, Mega Man Battle Network sequels, and deeper Scooby/Muppets routes.
