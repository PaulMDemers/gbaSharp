...
- Continue expanding `docs/gba-deep-gameplay-routes.csv` toward 20-30 representative gameplay scenes across additional RPG, platformer, racing, sports, and technical-stress titles. Good next candidates are Riviera, Summon Night, Crash/Spyro, Powerpuff Girls, Scooby-Doo Unmasked, Spy Muppets, Mario & Luigi, and Castlevania Circle/Harmony.
